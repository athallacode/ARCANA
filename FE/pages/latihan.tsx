...
// SVG component for glowing star
const GlowingStar = () => (
...
export default function Latihan() {
  ...
  const handleLanjut = () => {
    // Navigation for the next exercise/module
    alert("Melanjutkan latihan...");
  };
  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.topSection}>
        ...
        {/* Progress Card floating over the boundary */}
        <div className={styles.progressCard}>
          ...
          <div className={styles.progressActionRow}>
            <span className={styles.progressSubtitle}><strong>80%</strong> menuju level 3</span>
