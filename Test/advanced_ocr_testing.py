"""
Advanced OCR Testing dengan Visualization
Script untuk menampilkan hasil OCR dengan lebih detail dan visual
"""
...
class AdvancedOCRTester(OCRTester):
    """Extended OCRTester dengan visualization features"""
    ...
    def visualize_results(self, img_path, output_path=None):
        """
        Visualize OCR results dengan marking di gambar
    ...
    def compare_results(self, img_filename, expected_text):
        """
        Compare hasil OCR dengan expected text
        
        Args:
            img_filename: Nama file gambar
            expected_text: Text yang diharapkan
        """
    ...
    def _similarity_score(self, str1, str2):
        """
        Calculate similarity antara dua string
        Simple implementation menggunakan Levenshtein-like logic
        """
    ...
    def test_with_validation(self, test_cases):
        """
        Test multiple cases dengan validation
        
        Args:
            test_cases: List of (filename, expected_text) tuples
        """
        print(f"\n{'='*60}")
